...
namespace TechEliteWebshop.Areas.Identity.Data;
...
public class ApplicationUser : IdentityUser
{
    ...
    public required string CustomUserId { get; set; } = GenerateCustomUserId(); // Skapar ett mer läsbart ID för oss, UTÖVER det som Identity autoskapar
    ...
    {
        // Generera ett unikt CustomUserId
        return $"USR-{Guid.NewGuid().ToString().Substring(0, 8).ToUpper()}";
    }
}
