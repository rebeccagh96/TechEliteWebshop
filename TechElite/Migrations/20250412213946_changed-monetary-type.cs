...
{
    /// <inheritdoc />
    public partial class changedmonetarytype : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 2, "En produkt för alla", null, 1990.00m, "Mac Attack", 20 },
                    { 3, 3, "En produkt för alla", null, 19.00m, "Temu Earbuds", 15 },
                    { 4, 4, "En produkt för alla", null, 19.00m, "LADDARE X2000", 150 },
                    { 5, 5, "En produkt för alla", null, 199.00m, "Xbox Kontroll", 30 },
                    { 6, 1, "En produkt för alla", null, 19.00m, "Rit Bräda", 100 },
                    { 7, 2, "En produkt för alla", null, 1990.00m, "Windows Fusion", 10 },
                    { 8, 3, "En bra produkt för alla", null, 19.00m, "Professor Earbuds", 120 },
                    { 9, 4, "En bra product för alla", null, 19.00m, "Smart Charger", 35 },
                    { 10, 5, "En produkt för alla.", null, 199.00m, "Custom ps5 Kontroll", 10 },
                    { 11, 1, "En produkt för alla.", null, 19.00m, "Wish Rit Bräda", 15 },
                    { 12, 2, "En produkt för alla", null, 1990.00m, "Elite Monitor", 50 },
                    { 13, 3, "En produkt för alla.", null, 199.00m, "Airpods pro", 20 },
                    { 14, 4, "En produkt för alla.", null, 19.00m, "Supercharger adapter", 80 },
                    { 15, 5, "En produkt för alla.", null, 199.00m, "Standard PS Kontroll", 50 },
                    { 16, 1, "En produkt för alla.", null, 1990.00m, "iphone 7", 30 },
                    { 17, 2, "En produkt för alla.", null, 1990.00m, "PS5", 20 },
                    { 18, 3, "En produkt för alla.", null, 199.00m, "Trådade Ipods Pro", 20 },
                    { 19, 4, "En produkt för alla.", null, 19.00m, "iphone adapter", 30 },
                    { 20, 5, "En produkt för alla.", null, 1990.00m, "Nintendo", 20 },
                    { 21, 1, "En produkt för alla.", null, 1990.00m, "iphone 5", 20 },
                    { 22, 2, "En produkt för alla.", null, 1990.00m, "Win Screen", 20 },
                    { 23, 3, "En produkt för alla.", null, 199.00m, "WIN-Win Headpones", 20 },
                    { 24, 4, "En produkt för alla.", null, 199.00m, "Superb Fläkt", 25 },
                    { 25, 5, "En produkt för alla.", null, 1990.00m, "Playstation 1", 20 }
                });
